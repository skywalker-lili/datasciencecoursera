...
## Summary
In this prediction model, I combined 3 classifiers: random forests, linear discriminant analysis and support vector machines by majoraity voting (voting is realized by using random forest again). 
...
Thanks for your patience. Let's hope I am not too wrong about this!
